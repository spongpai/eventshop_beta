		...
		try {
			...
			while (res.next()) {
				...
				if (VISUAL.equals(res.getString(4))) {
					String filepathTransMatrix = tempDir + PATH_DS + dsId + UNDERSCORE + TRANSMATRIX;  	// wrong path
					String filepathColorsMatrx = tempDir + PATH_DS + dsId + UNDERSCORE + COLRSMATRIX;	// wrong path
