define([
...
], function($,jqueryui, _, Backbone,leaflet, queue,dalgorithms,ddalgorithms,dgraffle,dgraph,modal,paginate,sortable,queryGraph,d3,topojson,basic,bootMin,datetimepicker, 
  ...
  temporalCharOpView,registerDatasource,addDatasourceView,dataSourceModel,dataSourceCollection,registerQueryView,queryModel,queryGraphView,queryListCollection,userModel,editUserView,vizDatasourceView){
