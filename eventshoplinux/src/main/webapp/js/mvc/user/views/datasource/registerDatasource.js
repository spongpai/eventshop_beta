    ...
    fetchDatasource: function() {
		...
		dsList.fetch({
		    ...
		    success: function(){
		    	...
		    	// Do we need this window.ds_data? -- Siripen 11/27/14
		    	//window.ds_data = dsList;		    	
			    ...
			    // update data source multi-selection list in each operator tab
			    ...
			    // end multi-selection list in each operator tab
			}			   
	 });
    }
